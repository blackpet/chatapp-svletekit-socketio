...
{:else}
	...
	<div class="grid place-items-center h-screen h-screen-ios bg-gray-300">
		<div class="w-11/12 sm:max-w-[400px]">
			<h1 class="text-center text-3xl font-bold mb-8">Simple Chatapp</h1>
			<div class="bg-gray-100 rounded-xl p-16 pt-8 shadow-xl">
